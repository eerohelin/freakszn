...
export const DuoRequestModal = ({
  ...
  const [showDuoInvitePendingPopup, setShowDuoInvitePendingPopup] =
          ...
          <div className="bg bg-gradient-to-tr from-gray-600 to-gray-500 p-[0.065rem] rounded-[0.3rem]">
            <div className="p-6 rounded-[0.15rem] bg-card">
              ...
              <div className="flex gap-2 items-center">
                <div className="flex flex-col items-center content-center justify-center w-full">
                  <div className="flex items-center">
                    <div className="bg-gradient-to-b from-league-border to-league-borderdarker p-[0.05rem]">
                      <img
                        className="w-24"
              ...
              <div className="pb-4 flex flex-col gap-2">
                <ButtonFszn
                  className={cn(
                    (showMyRolePicker || showHisRolePicker) && "hidden",
                    ...
                    <div className="flex items-center gap-2">
                      {ROLES.map((r: string) => (
                        <ButtonFszn
                          ...
                          className={cn(
                            hisRole?.toLowerCase() === r.toLowerCase() &&
                    ...
                    <div className="flex items-center gap-2">
                      {ROLES.map((r: string) => (
                        <ButtonFszn
                          ...
                          className={cn(
                            myRole?.toLowerCase() === r.toLowerCase() &&
                              "pointer-events-none grayscale",
                            "bg-white/20 border-white/30",
                          )}
                        >
